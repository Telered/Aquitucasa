...
public class VentanaPropietario extends JFrame implements ActionListener, WindowListener {
    ...
    private void initComponents() {
        ...
        contenedor.setLayout(new GridLayout(16, 2));
        ...
        if (compruebaCadena20(nombre.getText())) {
            if (compruebaTelefono(telefono.getText())) {
                if (compruebaNif(nif.getText())) {
                    ...
                    String cadena = "INSERT INTO propietario (RAZON_SOCIAL, NIF,PROFESION,DIRECCION,ESTADO_CIVIL, TELEFONO,MOVIL,EMAIL,PASSWORD,PAGINA_WEB,FAX,LOCALIDAD_ID_LOC) VALUES ('"
                            + nombre.getText() + "',  '" + nif.getText() + "',  '" + profesion.getText() + "',  '" + direccion.getText() + "',  '" + estado.getText() + "',  '" + telefono.getText() + "',  '" + movil.getText() + "',  '" + email.getText() + "',  '" + password.getText() + "',  '" + pagina_web.getText() + "',  '" + fax.getText() + "',  '" + menu.getSelectedIndex() + "')";
